...
int main() {
  ...
  // Инициализация ImGui GLFW
  ImGui_ImplGlfw_InitForOpenGL(window, true);
  // Инициализация ImGui OpenGL
...
float b = 0.7f;
  ...
  GLint locA = glGetUniformLocation(shaderProgram.ID, "a");
  GLint locB = glGetUniformLocation(shaderProgram.ID, "b");


  // Original code from the tutorial
  Texture planksTex("resources/textures/Bark014_1K-PNG_Color.png",
                    GL_TEXTURE_2D, 0, GL_RGB, GL_UNSIGNED_BYTE);
  planksTex.texUnit(shaderProgram, "tex0", 0);
  Texture planksSpec("resources/textures/Bark014_1K-PNG_NormalGL.png",
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    ImGui::SliderFloat("a", &a, 0.1f, 10.0f, "a = %.1f");
    ImGui::SliderFloat("b", &b, 0.1f, 2.0f, "b = %.1f");
    ImGui::End();
