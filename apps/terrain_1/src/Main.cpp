...
public:
  ...
  virtual ~TerrainDemo1() { SAFE_DELETE(m_pGameCamera); }
  ...
  void PassiveMouseCB(int x, int y) { m_pGameCamera->OnMouse(x, y); }
...
private:
  void CreateWindow() {
    ...
    window = glfw_init(major_ver, minor_ver, WINDOW_WIDTH, WINDOW_HEIGHT,
                       is_full_screen, "Terrain Rendering - Demo 1");
